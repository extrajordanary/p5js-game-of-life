...
This is important for keeping a history of your changes and so that others can see your progress over time. This is similar to showing your work on a long math problem. We don't want to just see the final answer, we want to see the incremental work that went into creating the final product.

If you are not already familiar with using git and/or GitHub, you can check out the Product College prework [introduction to GitHub tutorials](https://github.com/MakeSchool/Product-College-Prework#git-and-github)  or you can simply copy and paste your changes into the file directly on GitHub.

![screenshot screenshot of saving directly on github](TODO)

When you do this, you'll be able to visit your project's GitHub page and see your updated program live on the internet. You can also share this link to friends and family so they can see your progress and eventually your finished project.
